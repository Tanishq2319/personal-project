      ...
      <div className="relative flex flex-col items-center gap-10">
        ...
        <div className="flex flex-col items-center">
          ...
          <motion.div
            ...
            transition={{ duration: 6, times: [0, 0.15, 0.9, 1], ease: "circOut" }}
          ...
          <motion.div
            ...
            transition={{ duration: 6, delay: 0.1, times: [0, 0.15, 0.9, 1], ease: "circOut" }}
        ...
        <motion.div
          ...
          transition={{ duration: 5.6, delay: 0.4, times: [0, 0.15, 0.9, 1] }}
