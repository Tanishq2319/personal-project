...
const paragraphs = [
  ...
  {
    text: `Or Gilly's. There was no big crowd, no grand masterplan, and no noisy table of people making a scene. It was just the two of us. But somewhere in the middle of that quiet evening, you casually pulled off your own little surprise — ordering a small cake, lighting a single candle, and bringing it over like it was the most natural thing in the world. In that moment, with just the two of us sitting there, it felt like a whole party. You looked so immensely pleased with yourself, laughing while I sat there completely caught off guard, not even knowing what face to make. It wasn't loud or extravagant, but it was perfect. I haven't forgotten a single second of it.`,
  },
  {
